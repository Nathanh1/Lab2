...
// Due Date:    3/4/2016
// Team:        203
// Description: LCD for Lab 2 Part 1 
// ******************************************************************************************* //
...
#define TRIS_RS   TRISCbits.TRISC4 //21
#define TRIS_RW   TRISCbits.TRISC14  //17
#define TRIS_E    TRISCbits.TRISC2 //19
...
#define LCD_RS    LATCbits.LATC4 //4 4 on LCD
#define LCD_RW    LATCbits.LATC14 //3 5 on LCD 
#define LCD_E     LATCbits.LATC2 //1 6 on LCD

#define LCD_D4    LATEbits.LATE7 //18 11 on LCD
#define LCD_D5    LATEbits.LATE5 //16 12 on LCD
#define LCD_D6    LATEbits.LATE3 //14 13 on LCD  
#define LCD_D7    LATEbits.LATE1 //12 14 on LCD
...
void writeFourBits(unsigned char word, unsigned int commandType, unsigned int delayAfter, unsigned int lower){
    ...
    LCD_RS = (commandType) ? INPUT : OUTPUT;   
    delayUs(1);
    LCD_D7 = (word>>3) & 1; 
    LCD_D6 = (word>>2) & 1;
    LCD_D5 = (word>>1) & 1;
    LCD_D4 = word & 1; //and  with 1 to get left significant bit        
    LCD_E = INPUT;
    delayUs(1);
    LCD_E = OUTPUT; 
    delayUs(delayAfter);
